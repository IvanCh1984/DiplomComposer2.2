                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="registerUser" method="post">
                                        <div class="form-group">
                                             <label class="form-label" for="emailverify">Имя</label>
                                             <input type="text" id="emailverify" name="name_user" class="form-control" placeholder="Ваше имя" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="userpassword" name="pass_user" class="form-control" placeholder="Пароль" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
